...
import { Play, Pause, RotateCcw, Wifi, Info, Clock, ChevronsRight } from 'lucide-react'
        ...
        <div className="aspect-video bg-black/30 rounded-lg p-4 flex items-center justify-center">
          <svg viewBox="0 0 100 40" className="w-full h-full text-slate-400">
            ...
            <g className="text-center">
              <circle cx="15" cy="20" r="4" fill="#1e293b" stroke="#0ea5e9" strokeWidth="0.7" />
              <text x="15" y="30" textAnchor="middle" className="text-[3px] fill-slate-200 font-semibold">客戶端</text>
            </g>
            <g>
              <circle cx="85" cy="20" r="4" fill="#1e293b" stroke="#0ea5e9" strokeWidth="0.7" />
              <text x="85" y="30" textAnchor="middle" className="text-[3px] fill-slate-200 font-semibold">伺服器</text>
            </g>
            
            {/* Connection Line */}
            <path d="M 19 20 H 81" stroke={renderState?.protocolColor || '#0ea5e9'} strokeWidth="0.5" strokeOpacity="0.6" strokeDasharray={renderState?.connectionStyle === 'dashed' ? '1,1' : 'none'} />
            ...
            {renderState && dotProgress > 0 && (
              <g>
                <circle
                  ...
                  fill={renderState.protocolColor || '#0ea5e9'}
                  filter="url(#glow)"
